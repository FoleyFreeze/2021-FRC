...
public class TransporterCals extends CalSet {
    ...
    public MotorCal rotateMotor = MotorCal.spark(12).pid(0.2, 0, 0.2, 0).invert().limit(0.5).ramp(0.3).currLim(30).currLimCount(25).currLimTime(1).resetEnc(false); 
    ...
    public double hasBallMaxV = 3.4;//1.1;     //was 2.25 max (MrC)
    public double hasBallMinV = 2.25;//.90;      //was 1.5  min (MrC)
    public int launcherValue = 2;
    public double countsPerIndex = 24/40.0 * 52/36.0 * 64/20.0 * 64/13.0;
    public double allowedIndexError = 0.15 * countsPerIndex;
